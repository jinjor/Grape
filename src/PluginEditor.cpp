...
GrapeAudioProcessorEditor::GrapeAudioProcessorEditor(GrapeAudioProcessor &p)
    : AudioProcessorEditor(&p),
      ...
      analyserWindow(&analyserMode,
                     ...
                     &p.monoStack,
                     p.mainParamList[128].envelopeParams,
                     p.mainParamList[128].oscParams,
                     p.mainParamList[128].filterParams,
                     p.mainParamList[128].modEnvParams),
      statusComponent(&p.polyphony, &p.timeConsumptionState, &p.latestDataProvider),
      masterComponent(p.globalParams),
      oscComponents{OscComponent(0, p.mainParamList[128].oscParams[0], p.controlItemParams),
                    OscComponent(1, p.mainParamList[128].oscParams[1], p.controlItemParams),
                    OscComponent(2, p.mainParamList[128].oscParams[2], p.controlItemParams)},
      envelopeComponents{EnvelopeComponent(0, p.mainParamList[128].envelopeParams[0]),
                         EnvelopeComponent(1, p.mainParamList[128].envelopeParams[1])},
      filterComponents{FilterComponent(0, p.mainParamList[128].filterParams[0], p.controlItemParams),
                       FilterComponent(1, p.mainParamList[128].filterParams[1], p.controlItemParams)},
      lfoComponents{LfoComponent(0, p.mainParamList[128].lfoParams[0], p.controlItemParams),
                    LfoComponent(1, p.mainParamList[128].lfoParams[1], p.controlItemParams),
                    LfoComponent(2, p.mainParamList[128].lfoParams[2], p.controlItemParams)},
      modEnvComponents{ModEnvComponent(0, p.mainParamList[128].modEnvParams[0]),
                       ModEnvComponent(1, p.mainParamList[128].modEnvParams[1]),
                       ModEnvComponent(2, p.mainParamList[128].modEnvParams[2])},
      delayComponent{DelayComponent(p.mainParamList[128].delayParams, p.controlItemParams)} {
